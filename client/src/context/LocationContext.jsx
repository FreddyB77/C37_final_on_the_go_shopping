...
app.get('/api/grocerys/search/:location/:term', (request, response) => {
  ...
  axios.get(`https://api.yelp.com/v3/businesses/search?categories=grocerys${locationSearch}${termSearch}&limit=50`, {
    headers: {
...
app.get(`/api/grocerys/:id`, async (request, response) => {
...
app.get(`/api/grocerys/:id/reviews/`, async(request,response) => {
  const { id } = request.params
